                ...
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        <div class="footer-logo">
                            <div class="site-logo">
                                <img src="{{ asset('assets/client/img/logo-2.png') }}" alt="Logo">
                            </div>
                        </div>
                        <p>VeggieShop – Cửa hàng chuyên cung cấp rau củ quả tươi ngon, an toàn và chất lượng. Chúng tôi cam kết mang đến những sản phẩm tốt nhất cho sức khỏe của bạn và gia đình.</p>
                                ...
                                <form action="https://gmail.us5.list-manage.com/subscribe/post?u=dde0a42ff09e8d43cad40dc82&amp;id=72d274d15d" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                    <div id="mc_embed_signup_scroll">
                                        <div class="mc-field-group">
                                            <input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Nhập email của bạn*">
                                        </div>
                                        ...
                                        <div style="position: absolute; left: -5000px;" aria-hidden="true">
                                            <input type="text" name="b_dde0a42ff09e8d43cad40dc82_72d274d15d" tabindex="-1" value="">
                                        </div>
                                        <div class="clear">
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="ltn__copyright-design clearfix">
                        <p>Bản quyền &copy; <span class="current-year"></span> <strong>VeggieShop</strong>. Mọi quyền được bảo lưu.</p>
                    </div>
                </div>
