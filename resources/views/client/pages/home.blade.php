                ...
                <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                    <div class="nav">
                        @foreach ($categories as $index => $category)
                            <a data-bs-toggle="tab" href="#liton_tab_3_{{ $index + 1 }}" class="{{ $index == 0 ? 'active show' : '' }}">{{ $category->name }}</a>
                        @endforeach
                    </div>
                </div>
                <div class="tab-content">
                    @foreach ($categories as $index => $category)
                        <div class="tab-pane fade {{ $index == 0 ? 'active show' : '' }}" id="liton_tab_3_{{ $index + 1 }}">
...
@include('client.components.modals.quick-view-modal')
<!-- MODAL AREA END -->

<!-- MODAL AREA START (Add To Cart Modal) -->
@include('client.components.modals.add-to-cart-modal')
<!-- MODAL AREA END -->

<!-- MODAL AREA START (Wishlist Modal) -->
@include('client.components.modals.wishlist-modal')
<!-- MODAL AREA END -->
