            ...
            <div class="col-lg-4">
                <aside class="sidebar-area ltn__right-sidebar">
                    ...
                    <div class="widget ltn__banner-widget">
                        <a href="shop.html"><img src="{{ asset('assets/client/img/banner/banner-3.jpg') }}" alt="Banner Image"></a>
                    </div>
...
<div class="ltn__counterup-area bg-image bg-overlay-theme-black-80 pt-115 pb-70 mb-100" data-bg="{{ asset('assets/client/img/bg/5.jpg') }}">
    <div class="container">
        <div class="row">
